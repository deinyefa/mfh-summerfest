    ...
    <>
      ...
      <section id="events" className="grid grid-cols-1 md:grid-cols-2 p-0">
        <div className="relative overflow-hidden bg-navy py-20 px-6 md:py-28 md:px-16">
          ...
          <div className="flex flex-wrap m-[-0.25rem]">
          ...
          <div className="mt-5 flex gap-2 flex-wrap">
            <a href="#schedule" className="inline-block bg-transparent text-white font-bold text-sm tracking-[0.08em] uppercase px-8 py-4 rounded-full border-2 border-white/40 cursor-pointer transition-all hover:border-sky hover:text-sky">View Schedule ↓</a>
        ...
        <div className="relative overflow-hidden bg-magenta py-20 px-6 md:py-28 md:px-16">
          <div className="text-[0.7rem] font-bold tracking-[0.2em] uppercase mb-5 flex items-center gap-2 text-white/60">🎵 Part Two</div>
          ...
          <div className="mt-5">
            <a href="#concert" className="inline-block bg-transparent text-white font-bold text-sm tracking-[0.08em] uppercase px-8 py-4 rounded-full border-2 border-white/40 cursor-pointer transition-all hover:border-sky hover:text-sky">Learn More ↓</a>
          </div>
