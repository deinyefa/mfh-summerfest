          ...
          <div className="flex flex-col gap-3 fade-up">
            ...
            <div className="flex items-stretch bg-white rounded-2xl overflow-hidden shadow-[0_2px_12px_rgba(43,51,95,0.06)] transition-all hover:shadow-[0_8px_32px_rgba(43,51,95,0.11)] hover:-translate-y-0.5">
              <div className="min-w-[170px] p-7 flex flex-col justify-center gap-1 shrink-0">
                ...
                <div className="text-[0.6rem] font-bold tracking-[0.15em] uppercase text-[#9099bf]">Group Stage</div>
              </div>
              ...
              <div className="flex-1 grid grid-cols-[1fr_auto_1fr] items-center text-center">
                <div className="p-6 flex flex-col gap-2">
                  <div className="text-[0.6rem] font-bold tracking-[0.18em] uppercase text-[#9099bf]">Game 1</div>
                ...
                <div className="p-6 flex flex-col gap-2">
                  <div className="text-[0.6rem] font-bold tracking-[0.18em] uppercase text-[#9099bf]">Game 2</div>
                  <div className="flex items-center gap-3 justify-center">
            ...
            <div className="flex items-stretch bg-navy-light text-white! rounded-2xl overflow-hidden shadow-[0_2px_12px_rgba(43,51,95,0.06)] transition-all hover:shadow-[0_8px_32px_rgba(43,51,95,0.11)] hover:-translate-y-0.5">
              <div className="min-w-[170px] p-7 flex flex-col justify-center gap-1 shrink-0">
                ...
                <div className="text-[0.6rem] font-bold tracking-[0.15em] uppercase text-[#9099bf]" style={{ color: "rgba(255,255,255,0.5)", }}>Semifinal</div>
              ...
              <div className="w-px bg-[#e8eaf5] shrink-0 my-5" style={{ background: "rgba(255,255,255,0.12)", }}></div>
              <div className="flex-1 grid grid-cols-[1fr_auto_1fr] items-center text-center">
                <div className="p-6 flex flex-col gap-2">
                  <div className="text-[0.6rem] font-bold tracking-[0.18em] uppercase text-[#9099bf]" style={{ color: "rgba(255,255,255,0.45)", }}>Game 1</div>
                  <div className="flex items-center gap-3 justify-center">
                    <span className="text-[1.05rem] font-bold text-navy" style={{ color: "var(--white)", }}>Winner G1</span>
                    ...
                    <span className="text-[1.05rem] font-bold text-navy" style={{ color: "var(--white)", }}>Runner-up G2</span>
                  </div>
                </div>
                <div className="w-px bg-[#e8eaf5] self-stretch my-4 shrink-0" style={{ background: "rgba(255,255,255,0.1)", }}></div>
                <div className="p-6 flex flex-col gap-2">
                  <div className="text-[0.6rem] font-bold tracking-[0.18em] uppercase text-[#9099bf]" style={{ color: "rgba(255,255,255,0.45)", }}>Game 2</div>
                  <div className="flex items-center gap-3 justify-center">
                    <span className="text-[1.05rem] font-bold text-navy" style={{ color: "var(--white)", }}>Winner G2</span>
                    <span className="w-8 h-8 rounded-full flex items-center justify-center text-[0.58rem] font-extrabold tracking-[0.05em] uppercase shrink-0 bg-white/10 text-white/55">vs</span>
                    <span className="text-[1.05rem] font-bold text-navy" style={{ color: "var(--white)", }}>Runner-up G1</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-stretch bg-navy-dark text-white! rounded-2xl overflow-hidden shadow-[0_2px_12px_rgba(43,51,95,0.06)] transition-all hover:shadow-[0_8px_32px_rgba(43,51,95,0.11)] hover:-translate-y-0.5">
              <div className="min-w-[170px] p-7 flex flex-col justify-center gap-1 shrink-0">
                ...
                <div className="text-[0.6rem] font-bold tracking-[0.15em] uppercase text-[#9099bf]" style={{ color: "rgba(255,255,255,0.5)", }}>Finals</div>
              ...
              <div className="flex-1 grid grid-cols-[1fr_auto_1fr] items-center text-center">
                <div className="p-6 flex flex-col gap-2">
                  <div className="text-[0.6rem] font-bold tracking-[0.18em] uppercase text-[#9099bf]" style={{ color: "rgba(255,255,255,0.45)", }}>3rd Place</div>
                  <div className="flex items-center gap-3 justify-center">
                    <span className="text-[1.05rem] font-bold text-navy" style={{ color: "var(--white)", }}>Loser SF1</span>
                    <span className="w-8 h-8 rounded-full flex items-center justify-center text-[0.58rem] font-extrabold tracking-[0.05em] uppercase shrink-0 bg-white/10 text-white/55">vs</span>
                    <span className="text-[1.05rem] font-bold text-navy" style={{ color: "var(--white)", }}>Loser SF2</span>
                  </div>
                </div>
                <div className="w-px bg-[#e8eaf5] self-stretch my-4 shrink-0" style={{ background: "rgba(255,255,255,0.1)", }}></div>
                <div className="p-6 flex flex-col gap-2">
                  <div className="text-[0.6rem] font-bold tracking-[0.18em] uppercase text-[#9099bf]" style={{ color: "rgba(255,255,255,0.45)", }}>Final</div>
                  <div className="flex items-center gap-3 justify-center">
                    <span className="text-[1.05rem] font-bold text-navy" style={{ color: "var(--white)", }}>Winner SF1</span>
