...
export default function Vendors() {
  ...
  return (
    <>
      ...
      <section
        id="vendors"
        className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start bg-white px-6 py-20 md:py-28 md:px-12"
      >
        ...
        >
          {isSubmitted ? (
            <div className="bg-white/15 border border-[#e8eaf5] rounded-3xl p-8 md:p-12 flex flex-col items-center justify-center text-center h-full min-h-[400px]">
              ...
              <p className="text-[#6b75a8] text-[0.95rem]">
                Thank you for applying to be a vendor. We will review your
            ...
            <form
              ...
              action="/vendor-application.html"
              method="POST"
              className="bg-white/15 border border-[#e8eaf5] rounded-3xl p-6 md:p-10 backdrop-blur-md"
            ...
            >
              ...
              />
              <div className="font-fraunces text-[1.4rem] mb-6 text-navy">
                Vendor Application
              </div>
              ...
              <div className="mb-5">
                <label
                  ...
                  className="text-navy-light/55 mb-2 uppercase text-sm font-semibold tracking-wider"
                >
                ...
                <input
                  ...
                  name="business_name"
                  required
                  className="w-full bg-white/10 border border-white/15 rounded-xl px-4 py-3 text-sm font-sans text-white outline-none transition-colors focus:border-sky focus:bg-sky/10 placeholder:text-white/30"
                  type="text"
                  placeholder="e.g. Auntie Grace's Kitchen"
                />
              </div>
              ...
              <div className="mb-5">
                ...
                >
                  ...
                  <option value="Children's Products">
                    {"Children's Products"}
                  </option>
              ...
              <div className="mb-5">
                ...
                <textarea
                  ...
                  className="w-full bg-white/10 border border-white/15 rounded-xl px-4 py-3 text-sm font-sans text-white outline-none transition-colors focus:border-sky focus:bg-sky/10 placeholder:text-white/30"
                  rows={3}
                  placeholder="Tell us a bit about what you'll be selling..."
                ></textarea>
              </div>
              ...
              <div className="mb-5">
                <label className="text-navy-light/55 mb-2 uppercase text-sm font-semibold tracking-wider">
                  I confirm that my products comply with Summer Fest guidelines
                </label>
                <div className="flex flex-col gap-2.5 mt-2">
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      required
                      className="w-[18px] h-[18px] accent-sky shrink-0"
                    />
                    <span className="text-navy-light text-sm">
                      I have read and agree to the vendor guidelines and
              ...
              <button
                ...
                className="inline-block bg-magenta text-white font-bold text-sm tracking-[0.08em] uppercase px-8 py-4 w-full mt-2 rounded-full border-none cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(208,25,101,0.4)] disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none"
              >
