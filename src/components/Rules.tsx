...
export default function Rules() {
  ...
  return (
    <section
      id="rules"
      className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start px-6 py-20 md:py-28 md:px-20 md:mx-20"
    >
      <div className="bg-navy-dark border border-white/10 p-6 md:p-10 rounded-3xl text-white col-span-2">
        <div className="text-sky uppercase text-[0.7rem] font-bold tracking-[0.2em] mb-4">
          Tournament Format
        </div>
      ...
      <div className="fade-up col-span-2 md:col-span-1">
        ...
        <p className="text-[1.05rem] leading-[1.75] text-[#555e8a] max-w-[55ch] mt-5">
          The tournament is open to anyone who wants to compete, as long as your
          team meets these requirements.
        </p>

        <ul className="list-none flex flex-col gap-4 mt-8">
          <li className="flex">
            <span className="w-6 h-6 min-w-6 bg-sky/30 text-sky rounded-full flex items-center justify-center text-xs font-bold mt-px mr-2">
              ✓
            </span>
          ...
          <li className="flex">
            ...
            <span>
              Soccer player age range: <strong>19 – 39 years old</strong>
            </span>
          </li>
          <li className="flex">
            <span className="w-6 h-6 min-w-6 bg-sky/30 text-sky rounded-full flex items-center justify-center text-xs font-bold mt-px mr-2">
            ...
            <span>
              ...
              <strong>kits and refreshments</strong>
            </span>
          </li>
          <li className="flex">
            <span className="w-6 h-6 min-w-6 bg-sky/30 text-sky rounded-full flex items-center justify-center text-xs font-bold mt-px mr-2">
            ...
            <span>
              All team members are required to be members of the same church
            </span>
          </li>
          <li className="flex">
            <span className="w-6 h-6 min-w-6 bg-sky/30 text-sky rounded-full flex items-center justify-center text-xs font-bold mt-px mr-2">
            ...
            <span>
              Fun sports games between matches are open to{" "}
              <strong>all adults 17+</strong> — no upper age limit
            </span>
          </li>
          <li className="flex">
            <span className="w-6 h-6 min-w-6 bg-sky/30 text-sky rounded-full flex items-center justify-center text-xs font-bold mt-px mr-2">
            ...
            <span>
              Format: <strong>Two groups of three → Knockout rounds</strong>
            </span>
          </li>
        </ul>
      </div>

      <div className="fade-up flex flex-col gap-8 md:gap-10 col-span-2 md:col-span-1">
        <div className="bg-white border border-[#555e8a]/20 p-6 md:p-10 rounded-3xl text-navy shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
          {isSubmitted ? (
            <div className="flex flex-col items-center justify-center text-center py-8">
              ...
              <h3 className="font-fraunces text-[1.6rem] text-navy mb-3">
                Team Registered!
              </h3>
              <p className="text-[#555e8a] text-[0.95rem]">
                {
                  "Thank you for signing up your team. We'll be in touch soon with more details."
                }
              </p>
            </div>
          ) : (
            <form
              name="team-signup"
              action="/team-signup.html"
              method="POST"
              onSubmit={handleSubmit}
            >
              <input type="hidden" name="form-name" value="team-signup" />
              <div className="font-fraunces text-[1.4rem] text-navy mb-6">
                Team Registration
              </div>
              ...
              <div className="mb-5">
                <label
                  htmlFor="church_name"
                  className="block text-xs font-bold tracking-widest uppercase text-[#555e8a] mb-2"
                >
                  Church / Organization
                </label>
                <input
                  ...
                  name="church_name"
                  required
                  className="w-full bg-white border border-[#555e8a]/20 rounded-xl px-4 py-3 text-sm font-sans text-navy outline-none transition-colors focus:border-sky focus:bg-sky/5 placeholder:text-[#555e8a]/40"
                  type="text"
              ...
              <div className="mb-6">
                ...
                >
                  <input
                    ...
                    className="mt-1"
                  />
                  <span className="text-sm text-[#555e8a]">
                    {
                      "We agree to the tournament rules and understand we are responsible for our own kits and refreshments."
                    }
                  </span>
                </label>
              </div>
